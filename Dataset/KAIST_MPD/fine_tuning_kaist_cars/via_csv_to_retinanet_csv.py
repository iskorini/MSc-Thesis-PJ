...
source_path = './random/set00/V000/via_export_csv.csv'
dataset_path = Path('/data/datasets/KAIST_MPD/rgbt-ped-detection/data/kaist-rgbt/images/set00/V000/lwir')

if __name__ == "__main__":
    df = pd.read_csv(source_path)
    with open('SET00.csv', 'w' ) as csvfile:
